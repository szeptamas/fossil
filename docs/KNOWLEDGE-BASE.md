...
3. `docs/HARDWARE-PROFILE.md` for hardware or resource questions
4. `docs/BUILD-RUNBOOK.md`
5. relevant source under `apps\`
6. SDK `DOCUMENTATION.md`
7. SDK working examples
8. `_knowledge-archive\INDEX.md`
9. Gadgetbridge and `fossil-hr-gbapps` source
10. archived issues, PRs, reviews, releases, and attachments
11. internet research only when local material is insufficient
